...
namespace FacturacionVERIFACTU.API.Data.Entities
{
    ...
    public class Cliente
    {
        ...
        [Column("regimen_recargo_equivalencia")]
        public bool RegimenRecargoEquivalencia { get; set; } = false;

        [Column("porcentaje_retencion_defecto", TypeName = "decimal(5,2)")]
        public decimal? PorcentajeRetencionDefecto { get; set; } = 0;

        [Column("tipo_cliente")]
        [MaxLength(20)]
        public string TipoCliente { get; set; } = "B2B"; // B2B, B2C, Profesional, Minorista

        [Column("notas_fiscales")]
        [MaxLength(500)]
